...
f = lambda x: jnp.cos(4.0 * x)
H = lambda x, w, theta: theta[0] * (
    0.5 * theta[1] * phi_prime(x, w) ** 2
...
# Test psi
psi_vals_cpp = np.loadtxt(prefix + "psi.csv")
psi_vals = vpsi(x, w)
...
# Test psi_prime
psi_prime_vals_cpp = np.loadtxt(prefix + "psi_prime.csv")
...
grad_w_psi_vals_cpp = np.loadtxt(prefix + "grad_w_psi.csv")
...
grad_w_psi_prime_vals_cpp = np.loadtxt(prefix + "grad_w_psi_prime.csv")
...
phi_vals_cpp = np.loadtxt(prefix + "phi.csv")
phi_vals = vphi(x, w)
...
# Test phi_prime
phi_prime_vals_cpp = np.loadtxt(prefix + "phi_prime.csv")
...
# Test the grad_w of psi
grad_w_phi_vals_cpp = np.loadtxt(prefix + "grad_w_phi.csv")
...
# Test the grad_w of psi_prime
grad_w_phi_prime_vals_cpp = np.loadtxt(prefix + "grad_w_phi_prime.csv")
